                ...
                <div class="box-header">
                  <h3 class="box-title">
                    <div style="float:left;margin:0 8px;">
                        <a href="<?php echo U("Channel/add",array("ss"=>7));?>" class="btn btn-block btn-default"><i class="fa fa-fw fa-plus"></i>添加</a>
                    </div>
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo['id']); ?></td>
                         ...
                         <td><?php echo C("DB_PREFIX");?>addon<?php echo ($vo["id"]); ?></td>
                         <td>
                           <?php  $tmp = M("Channeltype")->where("id=".$vo['reid'])->field("id,typename")->find(); echo $tmp['typename']; ?>
                         </td>
                          <td>
                            <a href="<?php echo U("Channel/fmanage",array("id"=>$vo['id'],"ss"=>7));?>"><i class="fa fa-fw fa-plus"></i>字段管理</a> | 
                            <a title="编辑" href="<?php echo U("Channel/edit",array("id"=>$vo['id'],"ss"=>7));?>"><i class="fa fa-fw fa-edit"></i></a> | <a data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？<br/><span class=\'label label-danger\'>注意会清空该频道下所有数据</span>','<?php echo U("Channel/delete",array("id"=>$vo['id']));?>')" title="删除"><i class="fa fa-fw fa-remove"></i></a>
                          </td>
