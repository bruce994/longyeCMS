          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" id="form1" action="<?php echo U("Admin/update");?>" class="pageForm required-validate">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label>权限(可管理的单位)</label>
                      <select name="typeid" class="form-control required">
                      <?php
 $typeid = empty($_SESSION["admin"]['typeid'])?0:$_SESSION["admin"]['typeid']; if($typeid == 0){ echo '<option value="0">所有权限</option>'; echo getJG(0,0,"",$vo['typeid']); }else{ echo getJG($typeid,0,"",$vo['typeid']); } ?>
                      </select>                  
                    </div>
