            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary" >
                ...
                <div class="box-header">
                    ...
                    <form id="form1"  action="<?php echo U("Map/index",array("ss"=>3));?>" method="get" class="pageForm required-validate">
      
                  <div class="form-group">
                      <label>切换城市</label>                        

                             <input readonly type="text" id="city"  name="city"  class="form-control required"  value="<?php echo empty($_GET['city'])?C('city'):$_GET['city'];?>"  data-toggle="modal" data-target="#myModalcity" >
...
function checked_city(){
  ...
  $('#myModalcity').modal('hide');
                        ...
                        <div class="form-group">
                            <label>关键词</label>                        
                             <input type="text" id="keyword"  name="keyword"  class="form-control required"  value="<?php echo $_GET['keyword'];?>" >
                        </div>
                ...
                <div class="box-body" id="modal_map">
                  <iframe id="ifupmap_map" src="<?php echo U("Public/map2",array("height"=>"500","city"=>$_GET['city'],"keyword"=>$_GET['keyword']));?>" frameborder="0" scrolling="no" height="500"></iframe>  
                </div>
