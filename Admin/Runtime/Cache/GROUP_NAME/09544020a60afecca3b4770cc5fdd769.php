      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">字段管理</a></li>
            <li class="active"><?php echo ($vo["typename"]); ?></li>
          </ol>
        </section>
                ...
                <div class="box-header">
                  <h3 class="box-title">
                    <div style="float:left;margin:0 8px;">
                        <a href="<?php echo U("Channel/fmanage_add",array("chid"=>$_GET["id"],"ss"=>7));?>" class="btn btn-block btn-default"><i class="fa fa-fw fa-plus"></i>添加</a>
                    </div>
                    <div style="float:left;">
                      <a href="#" id="ids0" class="btn btn-block btn-default" onclick="action('fmanage_del&id=','ids0');"> <i class="fa fa-fw fa-remove"></i>
                       删 除
                     </a>
                     </div>
                  </h3>
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td>
                         ...
                         <td>
                            <?php
 $tmp = M("Channeltype")->where("id=".$vo['chid'])->field("id,typename")->find(); echo $tmp['typename']; ?>
                         </td>
                         <td>
                             <?php
 $tmp = M("Sys_enum")->where("egroup='fieldtype'")->order("disorder")->select(); foreach ($tmp as $value) { if($value['evalue'] == $vo['typeid']){ echo $value['ename']; break; } } ?>
                         </td>
                         <td><?php echo ($vo['title']); ?></td>
                         <td><?php echo ($vo['fieldname']); ?></td>
                         <td><?php echo ($vo['fielddefault']); ?></td>
                         <td><?php echo ($vo['sort']); ?></td>
                         <td>
                           <?php if(($vo["displaylist"]) == "0"): ?><span class="label label-success">是</span><?php endif; ?>
                           <?php if(($vo["displaylist"]) == "1"): ?><span class="label label-danger">否</span><?php endif; ?>
                         </td>
                         <td>
                           <?php if(($vo["issearch"]) == "1"): ?><span class="label label-success">是</span><?php endif; ?>
                           <?php if(($vo["issearch"]) == "0"): ?><span class="label label-danger">否</span><?php endif; ?>
                         </td>
                          <td>
                              <a title="编辑" href="<?php echo U("Channel/fmanage_edit",array("id"=>$vo['id'],"ss"=>7));?>"><i class="fa fa-fw fa-edit"></i></a> | <a data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？','<?php echo U("Channel/fmanage_del",array("id"=>$vo['id']));?>');" title="删除"><i class="fa fa-fw fa-remove"></i></a>
                          </td>
